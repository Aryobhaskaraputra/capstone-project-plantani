# Capstone-Project-Plantani

# Cloud Computing

The Cloud Computing part of this project is creating cloud architectures, managing cloud services, deploying cloud architectures, building database APIs and machine learning model APIs for Plantani applications.

# DatabaseApi Documentation
## Auth Endpoint
...
# API MACHINE LEARNING MODEL-PlanTani
...
```json
    {
    "penyakit": "Kutu Kebul/Kutu Putih",
    "tanaman": "Cabai"
}
```
